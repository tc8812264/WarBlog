...
<%@ page import="javabean.PageBean,database.*" %>
<html lang="en">
<head>
    <meta charset="utf-8" />
		...
		<div class="">
			<div class="row">
				...
				<%for(int i = 0; i < tlist.size(); ++i) {
					...
					%>
					<div class="box">
						<a href="single_text?text_id=<%=map.get("text_id")%>&dianzanren=<%=map.get("text_author")%>"><h1 class="vid-name"><%out.print(map.get("text_name")); %></h1></a>
						<div class="info">
							<h5>By <%
							DB b1 = new DB();

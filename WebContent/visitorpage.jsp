...
<header>
    ...
    <nav id="menu" class="navbar container">
		...
		<%if(!list.isEmpty()) {%>
				<ul class="nav navbar-nav">
					...
					<li><a href="visitor_archive?visitor=<%out.print(vlist.get(0).get("user_name"));%>"><i class="fa fa-cubes"></i>他的文章</a></li>
					<li><a href="visitor_message?visitor=<%out.print(vlist.get(0).get("user_name"));%>"><i class="fa fa-cubes"></i>他的信息</a></li>		
					<li><a href="visitor_album?visitor=<%out.print(vlist.get(0).get("user_name"));%>"><i class="fa fa-cubes"></i>他的相册</a></li>
				</ul>
			<%}%>
	...
	<div class="featured container">
		<div class="row">
			...
			<%if(!vlist.isEmpty()) {%>
				<br><br>
				<div id="user_name" style="display:none"><% out.print(vlist.get(0).get("user_name"));%></div>
				<div style=" border-radius:70%; overflow:hidden; "><img   id="touxiang" src="images/<% out.print(vlist.get(0).get("user_touxiang"));%>"  style="width:100px; height:100px;"></div><br>
				 <font size="3px" ><b><% out.print(vlist.get(0).get("user_nicheng")); %></b></font><br><br>
				 <div><font size="1px"><b>我的等级：<% out.print(vlist.get(0).get("user_level")); %> 经验值：<% out.print(vlist.get(0).get("user_exe")); %></b></font></div>
				 <div><font size="1px"><b>文章数：<% out.print(vlist.get(0).get("user_textnum"));%> 评论数：<% out.print(vlist.get(0).get("user_comnum"));%></b></font></div>
				 <label id= "qianming_echo"style="diplay:block;"><font size="1px"><b><% out.print(vlist.get(0).get("user_qianming")); %></b></font><br></label>
	...
	<div id="page-content" class="index-page container">
		<div class="row">
			<div id="main-content"><!-- background not working -->
				...
				<%if(!vlist.isEmpty()) {
					ArrayList<HashMap<String,Object>> hot  = b.query("select * from texts where text_author = '"+vlist.get(0).get("user_name")+"' order by text_vote desc",null);
				...
				%>
					...
					<div class="box wrap-vid">
						...
						<div class="info">
							<h5>By <a href="visitor_echo?visitor=<%=hot.get(i).get("text_author")%>"><%=hot.get(i).get("text_author")%></a></h5>
			...
			<div id="sidebar">
				<div class="col-md-3">
					...
					<div class="widget wid-gallery">
						<div class="heading"><h4>最近访客</h4></div>
						<div class="content">
							<div class="col-md-4">
								<div class="row">

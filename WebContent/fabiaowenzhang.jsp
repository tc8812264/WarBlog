		...
		<div class="">
			<div class="row">
				<div id="main-content" class="col-md-8">
					<div class="box">
							<form action="new_text" method="post" enctype="multipart/form-data">
								<input type="hidden" id="user_name" name="user_name" value="<%out.print(list.get(0).get("user_name"));%>">
								<ul style="list-style:none;font-weight:bold;">
								<li>文章封面：<input id="file" type="file" name="file" onchange="PreviewImage(this, 'imgHeadPhoto', 'divPreview')"/><div id="divPreview" style="text-align:center">
	     					<img id="imgHeadPhoto" src="images/banner.jpg" style="width: 580px; height: 320px;border: solid 1px #d2e2e2;" alt="" />
							</div></li><br>
								<li>文章标题：<input type="text" id="text_name" name="text_name"></li>
								<br>
								<li>文章内容：<textarea id="text_content" name="content"  rows="10" cols="80"></textarea></li>
